<template>
    <button
        type="button"
        @click="toggle"
        class="w-10 h-10 grid place-items-center rounded-full border border-ink-700/15 dark:border-ink-100/10 hover:border-white/40 transition-colors text-ink-700 dark:text-ink-100/60"
